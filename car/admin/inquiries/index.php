		...
		<div class="card-body">
			<table class="table tabe-hover table-bordered table-compact" id="list">
				...
				<tbody>
					<?php
					$i = 1;
					$qry = $conn->query("SELECT * FROM `messages`ORDER BY `contact` DESC");
					...
					<tr>
						...
						<td><b class=""><?php echo ucwords($row['contact']) ?></b></td>
						<td><b class=""><?php echo ucwords($row['email']) ?></b></td>
						<td><b class=""><?php echo $row['message'] ?></b>
						</td>
