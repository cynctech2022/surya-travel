...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
		...
		<div class="card-body">
			<form id="blog">
				...
				<!-- <div class="row">
					<div class="col-md-12">
						<div class="form-group">
							<label for="" class="control-label">Author Image</label>
							<div class="custom-file">
								<input type="hidden" name="old_file" value="<?php echo isset($file_path) ? $file_path :'' ?>">
							<input type="file" class="custom-file-input rounded-circle" id="customFile" name="author-img" onchange="displayImg(this,$(this))">
							<label class="custom-file-label" for="customFile">Choose file</label>
							</div>
						</div>
						<div class="form-group d-flex justify-content-center">
				...
				<!-- <div class="row" class="details">
					...
					<div class="col-sm-6">
						<div class="form-group">
							...
							<textarea name="author-name" cols="30" rows="2" class="form-control"><?php echo isset($title) ? $title : '' ?></textarea>
						</div>
					</div>
				</div> -->
			</form>
		...
		<div class="card-footer">
			...
			<a class="btn btn-primary btn-sm" href="./?page=blog">Cancel</a>
		</div>
	</div>
</div>
<style>
				...
				success:function(resp){
					if(resp != undefined){
						if(resp.status == 'success'){
							location.href=_base_url_+"admin/?page=blog";
						}else{
							alert_toast("An error occured",'error')
							console.log(resp);
						}
